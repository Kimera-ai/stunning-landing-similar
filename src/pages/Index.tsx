    ...
    >
      <div className="w-full max-w-lg mx-auto text-center">
        ...
        <a 
          ...
          className="inline-block bg-brand-red text-white px-8 py-4 rounded-full text-xl font-bold flex items-center justify-center gap-2 hover:bg-opacity-90 transition-all"
          style={{ direction: "rtl" }}
        >
