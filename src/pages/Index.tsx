    ...
    >
      <div className="w-full max-w-6xl mx-auto text-center">
        ...
        <a 
          ...
          className="inline-block bg-brand-red text-white px-12 py-6 rounded-full text-4xl font-bold flex items-center justify-center gap-2 hover:bg-opacity-90 transition-all w-fit mx-auto animate-[breath_2s_ease-in-out_infinite]"
          style={{ direction: "rtl" }}
        >
